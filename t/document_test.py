...
class DocumentTest(TestCase):
    def testDocument(self):
        ...
        self.assertTrue(isinstance(doc.block(), collections.abc.Callable))
        self.assertTrue(isinstance(doc.blocks()['foo'], collections.abc.Callable))
        self.assertTrue(isinstance(doc.blocks()['bar'], collections.abc.Callable))
